...
<head>
    ...
    <title>EyeCons Admin Page</title>
</head>
<body>

   <div class="header container">
     <div class="navbar-header">
	  <h3><a class="admin_name">Admin PlayGround User - <?php echo $_SESSION['name']; ?></a></h3>
	 </div><!-- /.navbar-header -->
	 ...
	 <ul class="dropdown-navbar-right">
        <li class="list-group-item">
		 ...
		 <ul class="subnavbar-right list-group">
     ...
     <ul class="dropdown-navbar-right list-group">
	   <li class="list-group-item">
	     <a><i class="fa fa-bell"></i>&nbsp;<i class="fa fa-caret-down"></i></a>
		 
		 <ul class="subnavbar-right">
		   <li class="list-group-item"><a>Notification </a></li>
   ...
   <div class="body_container mb-5">
     <div class="left_sidebar ">
	   <div class="left_sidebar_box ">
	   
	   <ul class="left_sidebar_first_level list-group">

         <li class="list-group-item"><a href="../index.php" target="_blank" ><i class="fa fa-dashboard"></i> My Site</a></li>	   
	     
		 <li class="list-group-item">
		  <a href="#"><i class="fa fa-th-large"></i>&nbsp;Products <i class="arrow fa fa-angle-left"></i></a>
		 
		   <ul class="left_sidebar_second_level list-group">
		     <li class="list-group-item"><a href="index.php?action=add_pro">Add Product</a></li>
			 <li class="list-group-item"><a href="index.php?action=view_pro">View Products</a></li>
		 ...
		 <li class="list-group-item">
		  <a href="#"><i class="fa fa-plus"></i>&nbsp;Categories <i class="arrow fa fa-angle-left"></i></a>
		   ...
		   <ul class="left_sidebar_second_level list-group">
		     <li class="list-group-item"><a href="index.php?action=add_cat">Add Category</a></li>
			 <li class="list-group-item"><a href="index.php?action=view_cat">View Categories</a></li>
		   </ul><!-- /.left_sidebar_second_level -->
		 </li>
		 ...
		 <li class="list-group-item">
		  <a href="#"><i class="fa fa-plus"></i>&nbsp;Brands <i class="arrow fa fa-angle-left"></i></a>
		   ...
		   <ul class="left_sidebar_second_level list-group">
		     <li class="list-group-item"><a href="index.php?action=add_brand">Add Brand</a></li>
			 <li class="list-group-item"><a href="index.php?action=view_brands">View Brands</a></li>
		   </ul><!-- /.left_sidebar_second_level -->
		 </li>
		 ...
		 <li class="list-group-item">
		  <a href="#"><i class="fa fa-gift"></i>&nbsp;Admin <i class="arrow fa fa-angle-left"></i></a>
		   ...
		   <ul class="left_sidebar_second_level list-group">
		     <li class="list-group-item"><a href="index.php?action=add_user">Add User</a></li>
			 <li class="list-group-item"><a href="index.php?action=view_users">List Users</a></li>
		   </ul><!-- /.left_sidebar_second_level -->
		 </li>
